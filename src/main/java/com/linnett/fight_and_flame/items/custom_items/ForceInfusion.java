...
public class ForceInfusion extends PotionItem {

    public ForceInfusion(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (!level.isClientSide) {
            entity.addEffect(new MobEffectInstance(MobEffects.HEAL, 1200, 0)); // 60 секунд (1200 тиков)
